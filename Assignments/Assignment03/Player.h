...
class CBuildingPlayer : public CPlayer
{
public:
	CBuildingPlayer(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, void *pContext=NULL);
	virtual ~CBuildingPlayer();
